...
namespace WicNet
{
    public sealed class WicMetadataQueryWriter : IDisposable
    {
        private readonly IComObject<IWICMetadataQueryWriter> _comObject;

        public WicMetadataQueryWriter(object comObject)
        {
            _comObject = new ComObjectWrapper<IWICMetadataQueryWriter>(comObject).ComObject;
        }
