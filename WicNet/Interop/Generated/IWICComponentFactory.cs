...
namespace DirectN
{
    ...
    public partial interface IWICComponentFactory : IWICImagingFactory
    {
        ...
        [PreserveSig]
        new HRESULT CreateBitmap(/* [in] */ int uiWidth, /* [in] */ int uiHeight, /* [in] __RPC__in */ [MarshalAs(UnmanagedType.LPStruct)] REFWICPixelFormatGUID pixelFormat, /* [in] */ WICBitmapCreateCacheOption option, /* [out] __RPC__deref_out_opt */ out IWICBitmap ppIBitmap);
        ...
        [PreserveSig]
        new HRESULT CreateComponentEnumerator(/* [in] */ WICComponentType componentTypes, /* [in] */ WICComponentEnumerateOptions options, /* [out] __RPC__deref_out_opt */ out IEnumUnknown ppIEnumUnknown);
        ...
        [PreserveSig]
        HRESULT CreateEncoderPropertyBag(/* [size_is][unique][in] __RPC__in_ecount_full_opt(cCount) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] PROPBAG2[] ppropOptions, /* [in] */ int cCount, /* [out] __RPC__deref_out_opt */ out IPropertyBag2 ppIPropertyBag);
    }
}
