...
namespace WicNet.Interop
{
    ...
    public partial interface IWICImagingFactory
    {
        ...
        [PreserveSig]
        HRESULT CreateBitmap(/* [in] */ int uiWidth, /* [in] */ int uiHeight, /* [in] __RPC__in */ [MarshalAs(UnmanagedType.LPStruct)] REFWICPixelFormatGUID pixelFormat, /* [in] */ WICBitmapCreateCacheOption option, /* [out] __RPC__deref_out_opt */ out IWICBitmap ppIBitmap);
        ...
        [PreserveSig]
        HRESULT CreateBitmapFromSourceRect(/* [in] __RPC__in_opt */ IWICBitmapSource pIBitmapSource, /* [in] */ int x, /* [in] */ int y, /* [in] */ int width, /* [in] */ int height, /* [out] __RPC__deref_out_opt */ out IWICBitmap ppIBitmap);
        ...
        [PreserveSig]
        HRESULT CreateComponentEnumerator(/* [in] */ WICComponentType componentTypes, /* [in] */ WICComponentEnumerateOptions options, /* [out] __RPC__deref_out_opt */ out IEnumUnknown ppIEnumUnknown);
