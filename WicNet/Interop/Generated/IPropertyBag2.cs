...
namespace WicNet.Interop
{
    ...
    public partial interface IPropertyBag2
    {
        ...
        [PreserveSig]
        HRESULT Write(/* [in] */ int cProperties, /* [size_is][in] __RPC__in_ecount_full(cProperties) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 0)] PROPBAG2[] pPropBag, /* [size_is][in] __RPC__in_ecount_full(cProperties) */ IntPtr pvarValue);
        
        [PreserveSig]
        HRESULT CountProperties(/* [out] __RPC__out */ out uint pcProperties);
        
        [PreserveSig]
        HRESULT GetPropertyInfo(/* [in] */ uint iProperty, /* [in] */ int cProperties, /* [size_is][out] __RPC__out_ecount_full(cProperties) */ [Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] PROPBAG2[] pPropBag, /* [out] __RPC__out */ out uint pcProperties);
