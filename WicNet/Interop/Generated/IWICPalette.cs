...
namespace WicNet.Interop
{
    ...
    public partial interface IWICPalette
    {
        ...
        [PreserveSig]
        HRESULT InitializeFromBitmap(/* [in] __RPC__in_opt */ IWICBitmapSource pISurface, /* [in] */ int cCount, /* [in] */ bool fAddTransparentColor);
        ...
        [PreserveSig]
        HRESULT GetColorCount(/* [out] __RPC__out */ out int pcCount);
        
        [PreserveSig]
        HRESULT GetColors(/* [in] */ int cCount, /* [size_is][out] __RPC__out_ecount_full(cCount) */ [Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 0)] WicColor[] pColors, /* [out] __RPC__out */ out int pcActualColors);
