...
namespace DirectN
{
    ...
    public partial interface IWICColorTransform : IWICBitmapSource
    {
        ...
        // IWICColorTransform
        [PreserveSig]
        HRESULT Initialize(/* [in] __RPC__in_opt */ IWICBitmapSource pIBitmapSource, /* [in] __RPC__in_opt */ IWICColorContext pIContextSource, /* [in] __RPC__in_opt */ IWICColorContext pIContextDest, /* [in] __RPC__in */ [MarshalAs(UnmanagedType.LPStruct)] REFWICPixelFormatGUID pixelFmtDest);
    }
}
