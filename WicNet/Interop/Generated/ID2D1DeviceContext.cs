...
namespace DirectN
{
    ...
    public partial interface ID2D1DeviceContext : ID2D1RenderTarget
    {
        ...
        [PreserveSig]
        HRESULT CreateBitmapFromDxgiSurface(/* _In_ */ /*IDXGISurface*/ [MarshalAs(UnmanagedType.IUnknown)] object surface, /* optional(D2D1_BITMAP_PROPERTIES1) */ IntPtr bitmapProperties, /* _COM_Outptr_ */ out ID2D1Bitmap1 bitmap);
