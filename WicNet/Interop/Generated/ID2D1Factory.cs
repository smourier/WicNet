...
namespace DirectN
{
    ...
    public partial interface ID2D1Factory
    {
        ...
        [PreserveSig]
        HRESULT CreateDxgiSurfaceRenderTarget(/* _In_ */ /*IDXGISurface*/ [MarshalAs(UnmanagedType.IUnknown)] object dxgiSurface, /* _In_ */ ref D2D1_RENDER_TARGET_PROPERTIES renderTargetProperties, /* _COM_Outptr_ */ out ID2D1RenderTarget renderTarget);
