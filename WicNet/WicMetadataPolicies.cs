...
public class WicMetadataPolicies(WicMetadataQueryReader reader)
{
    [Browsable(false)]
    public WicMetadataQueryReader Reader { get; } = reader ?? throw new ArgumentNullException(nameof(reader));
