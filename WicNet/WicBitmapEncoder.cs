...
public sealed class WicBitmapEncoder(object comObject) : IDisposable
{
    private readonly IComObject<IWICBitmapEncoder> _comObject = new ComObjectWrapper<IWICBitmapEncoder>(comObject).ComObject;
