...
namespace WicNetExplorer.Utilities
{
    public static class Decamelizer
    {
        ...
        public static string? Decamelize(this string? text, DecamelizeOptions? options = null)
        {
        ...
        private static bool IsNewCategory(UnicodeCategory category, DecamelizeOptions options) => !(options.TextOptions.HasFlag(DecamelizeTextOptions.DontDecamelizeNumbers) && (category == UnicodeCategory.LetterNumber || category == UnicodeCategory.DecimalDigitNumber || category == UnicodeCategory.OtherNumber));
