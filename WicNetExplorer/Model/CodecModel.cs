...
namespace WicNetExplorer.Model
{
    ...
    public class CodecModel : ImagingComponentModel
    {
            ...
            : base(codec)
        {
            ...
            _codec = codec;
            PixelFormats = _codec.PixelFormatsList.Select(f => new PixelFormatModel(f)).ToArray();
            FileExtensions = _codec.FileExtensionsList.ToArray();
            MimeTypes = _codec.MimeTypesList.ToArray();
        }
